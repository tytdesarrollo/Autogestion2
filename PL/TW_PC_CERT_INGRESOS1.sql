create or replace PROCEDURE         TW_PC_CERT_INGRESOS1(CODIGO_EPL IN EMPLEADOS_BASIC.COD_EPL%TYPE, ANO_FORMU IN INTEGER, BLOQUE1 OUT VARCHAR2, BLOQUE2 OUT VARCHAR2)
...
BEGIN
                    ...
                    BEGIN
                    FECHAS := ' ';
                    For Fec_din IN FECHA_DINAMINCA
                    Loop
                        ANOCERTI := Fec_din.ANOCERTI;                    
                        FECHAS := FECHAS||ANOCERTI||'_*';    
                    End Loop;              
                END;   
